	...
	<div>
		...
		<b-modal ref="modal-edit" hide-footer title="Edit Employee">
			<b-form v-if="!modalLoading && entryEdit" @submit.prevent="updateEntry(entryEdit.id)">
				...
				<b-button variant="outline-danger" size="sm" @click="deleteEntry(entryEdit.id)">Delete</b-button>
				<b-button variant="outline-warning" size="sm" @click="hideModal">Cancel</b-button>
			</b-form>
...
<script>
// import dhModal from '~/components/dhModal.vue'
export default {
	data() {
		return {
